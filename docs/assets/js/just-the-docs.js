(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://github.com/gusmmm/jgmdendron/blob/main/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://github.com/gusmmm/jgmdendron/blob/main/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://github.com/gusmmm/jgmdendron/blob/main/assets/css/just-the-docs-' + theme + ".css"
      );
    };
